...
const LogoPreview = ({ designConfig }) => {
  ...
  const generatePattern = useCallback(() => {
    ...
    switch(patternType) {
      case 0:
        ...
        break;
      case 1:
        drawSierpinskiCarpet(ctx, symmetry, complexity, f1, f2, f3, colors.primary, colors.accent, colors.secondary);
        break;
      case 2:
        drawSquareResonator(ctx, symmetry, complexity, f1, f2, f3, colors.primary, colors.accent, colors.secondary);
        break;
      case 3:
        drawFishnet(ctx, symmetry, complexity, f1, f2, f3, colors.primary, colors.accent, colors.secondary);
        break;
      case 4:
        drawSquareSpiral(ctx, symmetry, complexity, f1, f2, f3, colors.primary, colors.accent, colors.secondary);
        break;
      case 5:
        drawNestedSquares(ctx, symmetry, complexity, f1, f2, f3, colors.primary, colors.accent, colors.secondary);
        break;
      case 6:
        drawDoubleCOpening(ctx, symmetry, complexity, f1, f2, f3, colors.primary, colors.accent, colors.secondary);
        break;
      case 7:
        drawGreekCross(ctx, symmetry, complexity, f1, f2, f3, colors.primary, colors.accent, colors.secondary);
        break;
      default:
        drawSpecialCross(ctx, symmetry, complexity, f1, f2, f3, colors.primary, colors.accent);
    }
  ...
  }, [colors, complexity, features, patternType, symmetry]);
