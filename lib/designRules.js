...
const drawDoubleCOpening = (ctx, symmetry, complexity, f1, f2, f3, primaryColor, secondaryColor, backgroundColor) => {
 ...
 极速版ctx.lineTo(100, 130);
  ...
  ctx.moveTo(150, 130);
  ctx.lineTo(150, 130 -极速版gapSize/2);
  ctx.stroke();
...
const drawGreekCross = (ctx, symmetry, complexity, f1, f2, f3, primaryColor, secondaryColor, backgroundColor) => {
  ...
  const armExtension = 10 *极速版f1 / 10;
  ...
  const generatePattern = useCallback(() => {
    ...
    switch(patternType) {
      case 0:
        ...
        break;
      case 1:
        drawSierpinskiCarpet(ctx, symmetry, complexity, f1,极速版f2, f3, primaryColor, accentColor, secondaryColor);
        break;
      case 2:
  ...
  return (
    <div style={{ textAlign: 'center', padding: '20px' }}>
      ...
      <div style={{ marginTop: '20px', fontSize: '14px', color: '#666' }}>
        <极速版p>布局: {layout} | 图案: {patternName}</极速版p>
